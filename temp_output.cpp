...
int main() {
    Vector<T> vec = vectorNew<int32_t>();
  ...
  exit(5);
    ...
    const Union_Some_None<T> first = vectorGet<int32_t>(&vec, 0);
    if ((first.__tag == Union_Some_None<T>::Tag::None)) {
  exit(6);
};
  ...
  exit(7);
    ...
    const Union_Some_None<T> second = vectorGet<int32_t>(&vec, 1);
    if ((second.__tag == Union_Some_None<T>::Tag::None)) {
  exit(8);
};
  ...
  exit(9);
    ...
    const Union_Some_None<T> third = vectorGet<int32_t>(&vec, 2);
    if ((third.__tag == Union_Some_None<T>::Tag::None)) {
  exit(10);
};
  ...
  exit(11);
    ...
    const Union_Some_None<T> invalid = vectorGet<int32_t>(&vec, 3);
    if ((invalid.__tag == Union_Some_None<T>::Tag::Some)) {
  exit(12);
};
