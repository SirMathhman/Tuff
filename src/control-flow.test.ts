...
test('evaluateTuff("let mut x = 0; while (x < 4) { x += 1; if (x == 2) { break; } } return x;") => 2', () => {
  expect(
    evaluateTuff(
      "let mut x = 0; while (x < 4) { x += 1; if (x == 2) { break; } } return x;",
    ),
  ).toEqual({
    ok: true,
    value: 2,
...
test('evaluateTuff("let mut x = 0; while (x < 4) { x += 1; if (x == 2) { break; } else { continue; } } return x;") => 2', () => {
  expect(
    evaluateTuff(
      "let mut x = 0; while (x < 4) { x += 1; if (x == 2) { break; } else { continue; } } return x;",
    ),
  ).toEqual({
    ok: true,
    value: 2,
