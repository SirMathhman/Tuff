...
export const typeRanges: Record<string, { min: number; max: number }> = {
  U8: { min: 0, max: 255 },
  U16: { min: 0, max: 65535 },
...
export function getLargestUsedType(typesUsed: Set<string>): string | undefined {
...
export function validateInRange(value: number, type: string): void {
...
export function determineCoercedType(types: string[]): string | undefined {
