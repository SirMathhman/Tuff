...
public class NodeJSEvaluatorTest {
	...
	@Test
	public void testInterpretWithStdin() throws IOException, InterruptedException {
		// Use parseInt to read from stdin and parse it
		String result = NodeJSEvaluator.interpret("parseInt(require('fs').readFileSync(0, 'utf-8'))", "100");
		assertEquals("100", result);
	}
}
