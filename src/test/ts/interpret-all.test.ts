...
describe("interpretAll - use statements", () => {
  itAllBoth(
    "executes main module with lib dependency via import",
    (assertValid) => {
...
describe("interpretAll - module references", () => {
  itAllBoth(
    "executes module function via variable reference",
    (assertValid) => {
      const config = new Map<string[], string>([
  ...
  itAllBoth(
    "executes module function with args via variable reference",
    (assertValid) => {
      const config = new Map<string[], string>([
...
describe("interpretAll - struct and native imports", () => {
  itAllBoth(
    "uses struct type from module with destructuring",
    (assertValid) => {
      const config = new Map<string[], string>([
        [
          ["main"],
