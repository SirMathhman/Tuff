...
export function set_fluff_missing_docs_options(severity) {
return fluff_set_missing_docs_options(severity);
}
...
export function set_fluff_simplify_negation_options(severity) {
return fluff_set_simplify_negation_options(severity);
}
...
if ((d.tag === "DFn")) {
fluff_check_missing_docs(src, span_start(d.span), d.name, "function", d.isOut);
const depReason = deprecation_reason_before(src, span_start(d.span));
if (depReason != "") {
