...
void test_interpret_function_implicit_return_type(void)
{
...
void test_interpret_struct_missing_fields_error(void)
{
...
void test_interpret_struct_undefined_fields_error(void)
{
...
void test_interpret_string_pointer_index(void)
{
    assert_success("let temp : *Str = \"test\"; temp[0]", 116, "test_interpret_string_pointer_index");
}

void test_interpret_string_pointer_index_last(void)
{
    assert_success("let temp : *Str = \"test\"; temp[3]", 116, "test_interpret_string_pointer_index_last");
}

void test_interpret_string_pointer_index_mid(void)
{
    assert_success("let temp : *Str = \"test\"; temp[1]", 101, "test_interpret_string_pointer_index_mid");
}
...
void test_interpret_slice_implicit_full_array(void)
{
...
int main(void)
{
    ...
    test_interpret_string_pointer_index();
    test_interpret_string_pointer_index_last();
    test_interpret_string_pointer_index_mid();
