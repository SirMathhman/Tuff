...
describe('let-bindings and reassignment', (): void => {
	...
	testBothValid('let x = read<U32>(); x', '100', 100);
	...
	testBothValid('let x = !read<Bool>(); x', 'true', 0);
	testBothValid('let x = !read<Bool>(); x', 'false', 1);
	testBothValid('let x = !!read<Bool>(); x', 'true', 1);
	testBothValid('let x = ! ! read<Bool>(); x', 'true', 1);
	testBothValid('let x = -read<U8>(); x', '10', -10);
	testBothValid('let x = - - 5; x', '', 5);
	testBothValid('let x = (-5); x', '', -5);
