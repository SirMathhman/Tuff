...
describe("interpret", () => {
  ...
  test('interpret("fn pass(value : I32) => value; pass(100)") should return 100', () => {
  ...
  test('interpret("fn add(this : I32, second : I32) : I32 => this + second; 3.add(4)") should return 7', () => {
    const result = interpret(
      "fn add(this : I32, second : I32) : I32 => this + second; 3.add(4)",
    );
    expect(result).toBe(7);
  });
  ...
  test('interpret("struct Empty {}") should return 0', () => {
  ...
  test('interpret("struct Point { x : I32; y : I32; } let point : Point = Point {};") should throw error', () => {
    expect(() =>
      interpret(
        "struct Point { x : I32; y : I32; } let point : Point = Point {};",
      ),
    ).toThrow();
  });
  ...
  test('interpret("this field mutation") should return 100', () => {
