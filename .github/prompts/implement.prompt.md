...
1. Implement a failing test. If this test passes, then write another test that fails.
...
3. Rebuild such that the changes in `main.tuff` are compiled to `main.js`. If `main.js` becomes malformed, restore it from version control.
