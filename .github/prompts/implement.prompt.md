...
1. Read the [entry file](../../src/index.ts) and [generated entry file](../../src/main.js) to understand the difference. Furthermore, you are advised to execute `bun run start` to get further information.
