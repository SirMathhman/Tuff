...
TEST(enums_basic) {
    assertEquals(
        ...
        compile(
            ...
            "let c = Color.Red; let g = Color.Green; g", "js")
    );
}
...
TEST(enums_comparison) {
    assertEquals(
        ...
        compile(
            ...
            "let s = Status.Success; let result = if (s == Status.Success) 100 else 200; result", "js")
    );
}
...
TEST(modules_basic) {
    assertEquals(
        ...
        compile(
            ...
            "let result = math::add(5, 3); result", "js")
    );
}
...
TEST(arrays_basic) {
    assertEquals(
        ...
        compile(
            ...
            "let first: I32 = arr[0]; let second: I32 = arr[1]; first + second", "js")
    );
}
