...
public:
	...
	std::string toString() const override {
		std::string opStr;
		switch (op) {
			case UnaryOp::STAR:   opStr = "*"; break;
			case UnaryOp::MUT:    opStr = "mut "; break;
			case UnaryOp::REF:    opStr = "&"; break;
			case UnaryOp::HASH:   opStr = "#"; break;
			case UnaryOp::MINUS:  opStr = "-"; break;
			case UnaryOp::NOT:    opStr = "!"; break;
			case UnaryOp::BITNOT: opStr = "~"; break;
		}
...
public:
	...
	std::string toString() const override {
		...
		switch (op) {
			...
			case BinaryOp::BIT_AND: opStr = "&"; break;
			case BinaryOp::BIT_OR:  opStr = "|"; break;
			case BinaryOp::BIT_XOR: opStr = "^"; break;
			case BinaryOp::SHL: opStr = "<<"; break;
			case BinaryOp::SHR: opStr = ">>"; break;
			case BinaryOp::UNION: opStr = "|"; break;
			case BinaryOp::INTERSECTION: opStr = "&"; break;
		}
