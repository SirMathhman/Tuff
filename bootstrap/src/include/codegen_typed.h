...
namespace codegen
{
	...
	public:
		std::string generate(ast::ExprPtr expr)
		{
			if (!expr)
				return "";
			return std::visit(ast::Overload{[this](const ast::Literal &e)
																			{ return genLiteral(e); },
																			[this](const ast::Identifier &e)
																			{ return genIdentifier(e); },
																			[this](const ast::BinaryOp &e)
																			{ return genBinaryOp(e); },
																			[this](const ast::UnaryOp &e)
																			{ return genUnaryOp(e); },
																			[this](const ast::Reference &e)
																			{ return genReference(e); },
																			[this](const ast::Deref &e)
																			{ return genDeref(e); },
																			[this](const ast::FieldAccess &e)
																			{ return genFieldAccess(e); },
																			[this](const ast::Index &e)
																			{ return genIndex(e); },
																			[this](const ast::Call &e)
																			{ return genCall(e); },
																			[this](const ast::StructLiteral &e)
																			{ return genStructLiteral(e); },
																			[this](const ast::ArrayLiteral &e)
																			{ return genArrayLiteral(e); },
																			[this](const ast::If &e)
																			{ return genIf(e); },
																			[this](const ast::Match &e)
																			{ return genMatch(e); },
																			[this](const ast::Is &e)
																			{ return genIs(e); },
		...
		std::string generateStmt(ast::StmtPtr stmt)
		{
			if (!stmt)
				return "";
			return std::visit(ast::Overload{[this](const ast::Let &s)
																			{ return genLet(s); },
																			[this](const ast::Assignment &s)
																			{ return genAssignment(s); },
																			[this](const ast::IfStmt &s)
																			{ return genIfStmt(s); },
																			[this](const ast::While &s)
																			{ return genWhile(s); },
																			[this](const ast::Loop &s)
																			{ return genLoop(s); },
																			[this](const ast::Break &) -> std::string
																			{ return "break;"; },
																			[this](const ast::Continue &) -> std::string
																			{ return "continue;"; },
																			[this](const ast::Return &s)
																			{ return genReturn(s); },
																			[this](const ast::ExprStmt &s)
